...
namespace ale10257\rabbitmq\tests\components;

use ale10257\rabbitmq\components\{
    Logger, Producer, Routing
};
use ale10257\rabbitmq\Configuration;
use ale10257\rabbitmq\events\RabbitMQPublisherEvent;
use ale10257\rabbitmq\exceptions\RuntimeException;
